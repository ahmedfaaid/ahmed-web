...
image:
  {
    path: './chuttersnap-fN603qcEA7g-unsplash.jpg',
    creator: 'chuttersnap',
    externalLink: 'https://unsplash.com/photos/fN603qcEA7g'
  }
embeddedImagesLocal: { paths: ['./nossr1.png', './nossr2.png'] }
...
<Image src={props.embeddedImagesLocal[0]} alt='Page without the chart' />
...
<Image src={props.embeddedImagesLocal[0]} alt='Page with the chart' />
