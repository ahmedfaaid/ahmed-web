...
image:
  {
    path: './ruben-bagues-ZzApzgh5lxo-unsplash.jpg',
...
<Image src={props.embeddedImagesLocal[0]} alt='Unpurged portfolio styles' />

<br />

<Image
  src={props.embeddedImagesLocal[1]}
...
<Image src={props.embeddedImagesLocal[2]} alt='Purged portfolio styles' />

<br />

<Image src={props.embeddedImagesLocal[2]} alt='Purged sneaker website styles' />
